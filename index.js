...
router.get('/', async (req, res) => {
    return res.render('pages/index', { data: [global._jadibot1, global._jadibot2, global._jadibot3, global._jadibot4, global._jadibot5] })
})
...
async function setAllJadibotData () {
    setTimeout(async () => {
        ...
        //     }
        // }
        Promise.all([getJadibot1(), getJadibot2(), getJadibot3(), getJadibot4(), getJadibot5()])
    }, 10000)
    return true
}